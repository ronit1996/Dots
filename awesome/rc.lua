...
globalkeys = gears.table.join(
	...
	awful.key({ modkey }, "b", function()
		awful.spawn("/home/ronit/.config/awesome/scripts/bluetooth_connect.sh")
	end, { description = "Bluetooth toggle switch", group = "hotkeys" }),

	-- SCREENSHOT SHORT CUT --
	awful.key({}, "Print", function()
		awful.spawn("/home/ronit/.config/awesome/scripts/screenshot.sh")
	...
	awful.key({ modkey }, "r", function()
		awful.util.spawn("rofi -show drun -icon-theme 'ePapirus' -show-icons")
...
awful.rules.rules = {
	...
	-- Set Applicatons to always map on the tag that has the app's icon on screen 1.
	{
		...
		properties = { screen = 1, tag = "  ", maximized = false, floating = false },
	},
	{ rule = { class = "Spotify" }, properties = { screen = 1, tag = "  " } },
	{ rule = { class = "discord" }, properties = { screen = 1, tag = " 󰙯 " } },
	{ rule = { class = "Steam" }, properties = { screen = 1, tag = " 󰓓 " } },
	{ rule = { class = "Houdini" }, properties = { screen = 1, tag = "  " } },
	{ rule = { class = "zoom" }, properties = { screen = 1, tag = " 󰍫 " } },
	{ rule = { class = "VirtualBox Manager" }, properties = { screen = 1, tag = "  " } },
}
-- }}}
...
awful.spawn.with_shell("conky -c ~/.config/conky/Shaula/Shaula.conf")
-- }}}
